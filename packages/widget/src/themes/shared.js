...
#valki-root .valki-inline-ellipsis{
  margin-left: 2px;
}

#valki-root .valki-sources-ellipsis .valki-ellipsis-dots{
  display: inline-flex;
  align-items: baseline;
  gap: 2px;
}

#valki-root .valki-sources-ellipsis .valki-ellipsis-dot{
...
#valki-root .valki-iqai-card{ padding:12px; display:flex; flex-direction:column; gap:9px; width:100%; max-width:none; }

@media (min-width: 1024px){
  #valki-root #valki-overlay[data-layout="desktop"] .valki-iqai-grid{
    display:grid;
    grid-template-columns:repeat(2, minmax(0, 1fr));
    column-gap:16px;
    row-gap:18px;
...
#valki-root .valki-iqai-left{ min-width:0; display:flex; flex-direction:column; gap:9px; }
#valki-root .valki-iqai-right{ min-width:0; display:flex; flex-direction:column; gap:8px; align-items:flex-end; }
#valki-root .valki-iqai-title-row{ display:flex; align-items:flex-start; gap:8px; }
#valki-root .valki-iqai-head{ display:flex; gap:10px; align-items:center; }
...
#valki-root .valki-iqai-avatar img{ width:100%; height:100%; object-fit:cover; object-position:center; display:block; position:absolute; inset:0; z-index:2; }
#valki-root .valki-iqai-avatar-fallback{ font-size:14px; font-weight:700; color:rgba(255,255,255,.9); line-height:1; position:absolute; inset:0; display:grid; place-items:center; z-index:1; transition:opacity .18s ease; pointer-events:none; }
#valki-root .valki-iqai-avatar:not(.is-fallback) .valki-iqai-avatar-fallback{ opacity:0; }
...
#valki-root .valki-iqai-bio{ color:rgba(255,255,255,.72); font-size:12px; line-height:1.45; min-height:36px; }
#valki-root .valki-iqai-stats{ display:grid; grid-template-columns:1fr 1fr; gap:6px; font-size:11px; color:var(--muted); }
#valki-root .valki-iqai-chart-region{ display:flex; flex-direction:column; align-items:flex-end; gap:8px; min-width:100%; width:100%; }
#valki-root .valki-iqai-chart-block{ display:flex; flex-direction:column; align-items:flex-end; gap:8px; min-width:0; width:100%; }
#valki-root .valki-iqai-footer-row{ display:flex; flex-direction:column; align-items:flex-end; gap:8px; min-width:0; width:100%; }
#valki-root .valki-iqai-price-wrap{ min-width:0; display:flex; flex-direction:column; align-items:flex-end; gap:4px; text-align:right; width:100%; }
#valki-root .valki-iqai-pair{ font-size:10px; letter-spacing:.06em; text-transform:uppercase; color:var(--muted-2); }
#valki-root .valki-iqai-card-price-row{ display:flex; align-items:center; justify-content:flex-end; gap:8px; min-height:22px; }
#valki-root .valki-iqai-price{ margin-top:0; font-size:13px; font-weight:700; }
#valki-root .valki-iqai-performance,
#valki-root .valki-iqai-change{ display:inline-flex; align-items:center; justify-content:center; padding:4px 10px; border-radius:999px; font-size:12px; font-weight:600; line-height:1; border:1px solid transparent; backdrop-filter:blur(8px); -webkit-backdrop-filter:blur(8px); }
#valki-root .valki-iqai-performance.positive,
#valki-root .valki-iqai-change.positive{ color:#22c55e; background:rgba(34,197,94,.15); border-color:rgba(34,197,94,.35); }
#valki-root .valki-iqai-performance.negative,
#valki-root .valki-iqai-change.negative{ color:#ef4444; background:rgba(239,68,68,.15); border-color:rgba(239,68,68,.32); }
#valki-root .valki-iqai-performance.neutral,
#valki-root .valki-iqai-change.neutral{ color:#e5e7eb; background:rgba(156,163,175,.14); border-color:rgba(156,163,175,.3); }
...
#valki-root #valki-iqai-prices-table{ table-layout:fixed; }
#valki-root #valki-iqai-prices-table th:nth-child(1),
#valki-root #valki-iqai-prices-table td:nth-child(1){ width:88px; }
#valki-root #valki-iqai-prices-table th:nth-child(2),
#valki-root #valki-iqai-prices-table td:nth-child(2){ width:auto; min-width:180px; }
#valki-root #valki-iqai-prices-table th:nth-child(3),
#valki-root #valki-iqai-prices-table td:nth-child(3){ width:140px; }
#valki-root #valki-iqai-prices-table th:nth-child(4),
#valki-root #valki-iqai-prices-table td:nth-child(4){ width:140px; }
...
#valki-root #valki-overlay[data-layout="mobile"] .valki-iqai-right{ align-items:flex-end; width:100%; }
...
@media (min-width: 1024px){
  ...
  #valki-root #valki-overlay[data-layout="desktop"][data-view="iqai"] .valki-chat-shell{
    width: min(1200px, 100%);
  }
  ...
  #valki-root #valki-overlay[data-layout="desktop"][data-view="iqai"] .valki-sidebar{
    display: none !important;
    flex: 0 0 0;
    max-width: 0;
  }

  #valki-root #valki-overlay[data-layout="desktop"][data-view="iqai"] .valki-modal{
    border-radius: 16px;
    width: 100%;
    flex: 1 1 100%;
  }

  #valki-root #valki-overlay[data-layout="desktop"] .valki-modal::before,
  #valki-root #valki-overlay[data-layout="desktop"] .valki-modal::after{
    display: none;
  }
}
...
#valki-root .valki-msg-row.bot.valki-sources-placeholder .valki-msg-bubble{
  border-color: rgba(241,90,36,.38);
  box-shadow: 0 10px 28px rgba(0,0,0,.32), 0 0 18px rgba(241,90,36,.24);
  overflow: hidden;
}
...
#valki-root .valki-msg-row.bot.valki-sources-placeholder .valki-msg-bubble::after{
  ...
  background: linear-gradient(
    120deg,
    rgba(241,90,36,0) 0%,
    rgba(241,90,36,.18) 28%,
    rgba(255,255,255,.22) 50%,
    rgba(241,90,36,.16) 72%,
    rgba(241,90,36,0) 100%
  );
  transform: translateX(-60%);
  animation: valki-sources-shimmer 1.6s ease-in-out infinite;
  pointer-events: none;
}
...
#valki-root .valki-chat-form{
  ...
  backdrop-filter: none;
  overflow: hidden;
  padding: 10px 0 calc(var(--valki-chat-pad-bottom) + var(--keyboard-bottom)) !important;
}
  #valki-root .valki-chat-form::before{
    content: "";
    position: absolute;
    inset: 0;
    background: linear-gradient(
...
#valki-root .valki-chat-composer{
  display:grid;
...
#valki-root .valki-chat-attach::before{
  content: "";
  position: absolute;
  inset: 2px;
  border-radius: 50%;
...
#valki-root .valki-chat-attach svg{
  position: relative;
  z-index: 1;
}
...
#valki-root .valki-chat-attach:hover::before{
  background: rgba(255,255,255,.09);
  border-color: rgba(255,255,255,.2);
  box-shadow: 0 12px 28px rgba(0,0,0,.32);
}
#valki-root .valki-chat-attach:active{
  transform: translateY(0);
  filter: brightness(.98);
}
#valki-root .valki-chat-attach[disabled]{ opacity:.55; pointer-events:none; }
#valki-root .valki-chat-attach:focus-visible{
  outline: none;
...
#valki-root .valki-chat-input::placeholder{ color: rgba(255,255,255,.36); }
...
#valki-root .valki-chat-send:active{
  transform: translateY(0);
...
@media (max-width: 640px){
  ...
  /* Mobile: ChatGPT-like caret baseline + prevent iOS caret misalignment */
  #valki-root .valki-chat-input{
    flex: 1 1 auto;
    min-width: 0;
...
@media (max-width:640px){
  ...
  #valki-root .valki-chat-attach{ width: 44px; height: 44px; }
  #valki-root .valki-chat-send{ width: 44px; height: 44px; }
  #valki-root .valki-bubble{
    right: 14px;
