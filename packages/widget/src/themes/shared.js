...
#valki-root .valki-iqai-title-row{ display:flex; justify-content:space-between; align-items:flex-start; gap:8px; }
...
#valki-root .valki-iqai-chart-region{ display:flex; flex-direction:column; align-items:flex-end; gap:8px; min-width:100%; }
#valki-root .valki-iqai-chart-block{ display:grid; grid-template-columns:minmax(0,1fr); align-items:center; gap:10px; min-width:0; width:100%; }
#valki-root .valki-iqai-price-wrap{ min-width:0; display:flex; flex-direction:column; align-items:flex-end; gap:4px; text-align:right; }
...
#valki-root .valki-iqai-open-signal{ padding:5px 10px; font-size:11px; line-height:1.1; flex-shrink:0; }
...
#valki-root .valki-iqai-range{ display:flex; justify-content:flex-end; flex-wrap:wrap; gap:6px; }
#valki-root .valki-iqai-range-option{ font-size:10px; letter-spacing:.06em; text-transform:uppercase; color:var(--muted); border:1px solid var(--border-soft); border-radius:999px; padding:2px 7px; line-height:1.1; }
#valki-root .valki-iqai-range-option.is-active{ color:#d1fae5; border-color:rgba(34,197,94,.45); background:rgba(34,197,94,.16); }
...
@media (max-width: 900px){
  ...
  #valki-root .valki-iqai-chart-region{ width:100%; align-items:stretch; }
    #valki-root .valki-iqai-chart-block{ grid-template-columns:minmax(0,1fr); gap:8px; }
